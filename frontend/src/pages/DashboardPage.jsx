              ...
              {todayTasks.map((task) => {
                ...
                return (
                  <div
                    ...
                    className="px-3 py-2 bg-slate-50/70 hover:bg-slate-50 rounded-xl border border-slate-200/80 transition-all shadow-xs flex flex-col gap-2"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          ...
                          <div className="inline-flex flex-wrap items-center gap-1">
                            <span className={`px-1.5 py-0.5 rounded text-[8.5px] font-extrabold uppercase tracking-wider ${task.schedule === 'daily' ? 'bg-blue-50 text-blue-700 border border-blue-100' :
                            ...
                            <span className="px-1.5 py-0.5 rounded text-[8.5px] font-extrabold uppercase tracking-wider bg-slate-200/80 text-slate-700">
                              {task.type}
                            </span>
                            {isCompleted ? (
                              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-50 text-emerald-700 font-extrabold rounded text-[8.5px] border border-emerald-100">
                                <CheckCircle2 className="w-3 h-3 text-emerald-600" /> Completed
                              </span>
                            ) : (
                              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-amber-50 text-amber-700 font-extrabold rounded text-[8.5px] border border-amber-100">
                        ...
                        {task.description && (
                          <p className="text-[10.5px] text-slate-500 mt-0.5 leading-normal max-w-2xl">{task.description}</p>
                        )}
                      </div>

                      {/* Right: Location & Completion Action */}
                      <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2 shrink-0 w-full sm:w-auto">
                        <div className="text-left sm:text-right shrink-0">
                          <p className="text-[8px] font-extrabold uppercase tracking-wider text-slate-400">Location</p>
                          <p className="text-[11px] font-bold text-slate-800 mt-0.5 leading-none">
                        ...
                        {!isCompleted && canCompleteAdminTask && (
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded bg-blue-600 px-2.5 py-1 text-[10px] font-bold text-white shadow-xs transition-all hover:bg-blue-700 shrink-0 cursor-pointer"
                          >
